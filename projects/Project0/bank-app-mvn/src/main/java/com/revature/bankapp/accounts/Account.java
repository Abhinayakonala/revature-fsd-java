...
public class Account {
	...
	public double withdraw(double withdrawAmount, AccountDaoImpl accdao) {
		while (success) {
			if (withdrawAmount < 0) {
	...
	public double deposit(double depositAmount, AccountDaoImpl accdao) {
		while (success) {
			if (depositAmount < 0) {
				System.out.println("Enter Amount greater than 0");
			} else {
	...
	public void transfer(double amount, AccountDaoImpl accdao) {
